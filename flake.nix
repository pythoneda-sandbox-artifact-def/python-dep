...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-artifact-application = {
      ...
      url = "github:pythoneda-shared-artifact-def/application/0.0.39";
    };
    ...
    pythoneda-shared-artifact-infrastructure = {
      ...
      inputs.pythoneda-shared-domain.follows =
        "pythoneda-shared-domain";
      url = "github:pythoneda-shared-artifact-def/infrastructure/0.0.41";
    };
    pythoneda-shared-artifact-shared = {
      ...
      inputs.pythoneda-shared-domain.follows =
        "pythoneda-shared-domain";
      url = "github:pythoneda-shared-artifact-def/shared/0.0.48";
    };
    pythoneda-shared-application = {
      ...
      inputs.pythoneda-shared-domain.follows =
        "pythoneda-shared-domain";
      url = "github:pythoneda-shared-def/application/0.0.55";
    };
    pythoneda-shared-banner = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixos.follows = "nixos";
