...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-artifact-application = {
      ...
      url = "github:pythoneda-shared-artifact-def/application/0.0.90";
    };
    pythoneda-shared-artifact-events = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-artifact-def/events/0.0.87";
    };
    pythoneda-shared-artifact-events-infrastructure = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-artifact-def/events-infrastructure/0.0.76";
    };
    pythoneda-shared-artifact-infrastructure = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-artifact-def/infrastructure/0.0.87";
    };
    pythoneda-shared-artifact-shared = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-artifact-def/shared/0.0.96";
    };
    pythoneda-shared-pythonlang-application = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-pythonlang-def/application/0.0.109";
    };
    pythoneda-shared-pythonlang-banner = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixpkgs.follows = "nixpkgs";
      ...
      let
        ...
        pythoneda-sandbox-python-dep-artifact-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            unpackPhase = ''
              command cp -r ${src} .
              sourceRoot=$(command ls | grep -v env-vars)
