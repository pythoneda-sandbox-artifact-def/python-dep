...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-artifact-application = {
      ...
      url = "github:pythoneda-shared-artifact-def/application/0.0.24";
    };
    ...
    pythoneda-shared-artifact-events-infrastructure = {
      ...
      inputs.pythoneda-shared-domain.follows =
        "pythoneda-shared-domain";
      url = "github:pythoneda-shared-artifact-def/events-infrastructure/0.0.20";
    };
    pythoneda-shared-artifact-infrastructure = {
      ...
      inputs.pythoneda-shared-domain.follows =
        "pythoneda-shared-domain";
      url = "github:pythoneda-shared-artifact-def/infrastructure/0.0.27";
    };
    ...
    pythoneda-shared-application = {
      ...
      inputs.pythoneda-shared-domain.follows =
        "pythoneda-shared-domain";
      url = "github:pythoneda-shared-def/application/0.0.38";
    };
    pythoneda-shared-banner = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixos.follows = "nixos";
  ...
  outputs = inputs:
    ...
    in flake-utils.lib.eachSystem supportedSystems (system:
      let
        ...
        repo = "python-dep";
        version = "0.0.149";
        sha256 = "0jq0xsas0lala8m4k6h2i018vw1bkjqqa2sl2fdxb427zczl3yd9";
        pname = "${org}-${repo}";
